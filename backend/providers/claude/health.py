# providers/claude/health.py
"""
Capture health for the Claude provider - see providers/chatgpt/health.py's
module docstring, which applies identically here (this is a straight
provider-parameterized copy against the same shared ConversationCaptureHealth
table, scoped by provider="claude").
"""
