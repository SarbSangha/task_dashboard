...
router.add_api_route("/{task_id}/stages/{stage_id}/submit", handlers.submit_task_stage, methods=["POST"])
router.add_api_route("/{task_id}/stages/{stage_id}/approve", handlers.approve_task_stage, methods=["POST"])
...
router.add_api_route("/notifications/push/config", handlers.get_web_push_config, methods=["GET"])
router.add_api_route("/notifications/push/subscribe", handlers.subscribe_web_push, methods=["POST"])
router.add_api_route("/notifications/push/unsubscribe", handlers.unsubscribe_web_push, methods=["POST"])
