...
def _sheet_tool_assignments(ws, snapshot):
    ...
    row = C.data_table(ws, [
        ...
        C.Col("Purchase date", 16, key="purchaseDate"),
        C.Col("Credit system", 14, key="creditEnabled"),
        C.Col("Renewal type", 18, key="renewalType"),
    ...
    row = C.data_table(ws, [
        ...
        C.Col("Credit system", 14, key="creditEnabled"),
        C.Col("Renewal type", 18, key="renewalType"),
        C.Col("Remaining credits", 18, key="remainingCredits"),
        C.Col("Renewal status", 18, key="renewalStatus"),
        C.Col("Cost (₹)", 14, key="cost"),
