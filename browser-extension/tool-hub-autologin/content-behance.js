...
const FRESH_SESSION_PREPARED_KEY = 'rmw_behance_fresh_session_prepared';
...
function clearLocalBehanceStorage() {
  try {
...
async function ensureFreshLaunchSession() {
  ...
  setStatus('Preparing fresh Behance session');
  ...
  window.location.replace('https://www.behance.net/');
  return false;
}
