...
const ClaudeCaptureCenterTab = lazy(() => import('./tabs/ClaudeCaptureCenterTab'));
...
const SECONDARY_TABS = [
  ...
  { key: 'claude-capture-center', label: 'Claude Capture', icon: '✳️', adminOnly: true },
...
const TAB_COMPONENTS = {
  ...
  'claude-capture-center': ClaudeCaptureCenterTab,
...
const TAB_SKELETON_VARIANTS = {
  ...
  'claude-capture-center': 'projects',
