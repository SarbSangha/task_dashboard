...
// Local copy - mirrors grammarly-docs-capture/JsonViewer.jsx /
// chatgpt-capture/JsonViewer.jsx exactly (see this provider folder's own
// convention: each capture tab keeps its own copy rather than a
// cross-folder import).
