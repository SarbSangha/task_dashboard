...
import { copyTextToClipboard } from './elevenlabsCaptureUtils';

// Byte-for-byte the same component as every other provider's JsonViewer.jsx
// (flow-capture, freepik-capture, envato-capture, ...), kept as its own copy
// so this provider folder stays self-contained.
