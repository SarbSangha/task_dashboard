...
import { copyTextToClipboard } from './envatoCaptureUtils';

// Byte-for-byte the same component as freepik-capture/JsonViewer.jsx, kept
// as its own copy so this provider folder stays self-contained.
