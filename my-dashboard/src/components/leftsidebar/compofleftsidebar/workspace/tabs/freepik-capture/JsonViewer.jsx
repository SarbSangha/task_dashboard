...
import { copyTextToClipboard } from './freepikCaptureUtils';

// Byte-for-byte the same component as chatgpt-capture/JsonViewer.jsx, kept
// as its own copy rather than a cross-folder import so this provider folder
// stays self-contained (same convention ChatGPT's own folder follows).
