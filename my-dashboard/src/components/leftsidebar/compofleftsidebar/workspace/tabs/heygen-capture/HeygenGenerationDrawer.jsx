...
// freepik-capture/FreepikGenerationDrawer.jsx, so the three providers'
 ...
 * KlingGenerationDrawer.jsx/FreepikGenerationDrawer.jsx: portal to
 * document.body, mount only while a generation is selected, Escape-to-close.
 */
export default function HeygenGenerationDrawer({ generationId, onClose }) {
  useEffect(() => {
