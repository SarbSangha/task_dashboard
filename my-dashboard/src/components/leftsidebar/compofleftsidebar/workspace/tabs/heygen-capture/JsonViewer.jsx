...
import { copyTextToClipboard } from './heygenCaptureUtils';

// Byte-for-byte the same component as freepik-capture/JsonViewer.jsx /
// chatgpt-capture/JsonViewer.jsx, kept as its own copy rather than a
// cross-folder import so this provider folder stays self-contained (same
// convention every other provider folder follows).
