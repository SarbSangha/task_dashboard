...
import { formatCount, formatCredits } from './higgsfieldCaptureUtils';
  ...
  return (
    <div className="chatgpt-capture-metrics-grid">
      ...
      <MetricCard
        ...
        hint={unknownCount > 0 ? 'No ticket was active at capture time' : undefined}
      />
      <MetricCard icon="💳" tone="info" label="Credits Used (total)" value={formatCredits(metrics.creditsUsedTotal)} />
    </div>
  );
}
