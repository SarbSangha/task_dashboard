...
const PromptPerformance = ({ filters }) => {
  ...
  return (
    <div>
      ...
      <div className="rpt-kpi-grid">
        <KpiCard label="Total Prompts" metric={k.totalPrompts} />
        <KpiCard label="Successful Prompt %" metric={k.successfulPct} format="pct" />
        <KpiCard label="Prompt Reuse Rate" metric={k.reuseRate} format="pct" />
        <KpiCard label="Unique Prompts" metric={k.uniquePrompts} />
        <KpiCard label="Avg Prompt Length" metric={k.avgLength} />
      </div>

      <div className="rpt-grid cols-2">
        <ChartFrame title="Prompt success rate over time" hint="Daily" height={250}>
        ...
        <ChartFrame title="Prompt volume" hint="Daily" height={250}>
        ...
        <ChartFrame title="Top prompt themes" hint="From tags" height={240}>
        ...
        <ChartFrame title="Success rate by model" hint="Prompt → output" height={240}>
